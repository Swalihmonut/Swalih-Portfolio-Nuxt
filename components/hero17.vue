          ...
          <slot name="heading1">
            ...
            <div class="hero17-fragment3">
              <span class="hero17-text7">
                Experienced Business Analyst in Life Sciences Manufacturing
              </span>
            </div>
          </slot>
        </h1>
          ...
          <slot name="content1">
            ...
            <div class="hero17-fragment1">
              <span class="hero17-text5">
                With over 15 years of expertise in business analysis within the
                life sciences manufacturing industry, I bring a wealth of
                knowledge and skills to drive impactful insights and strategies.
              </span>
            </div>
          </slot>
        </p>
          ...
          <span class="thq-body-small">
            <slot name="action1">
              ...
              <div class="hero17-fragment4">
                <span class="hero17-text8">View Projects</span>
              </div>
            </slot>
          </span>
        </button>
          ...
          <span class="thq-body-small">
            <slot name="action2">
              ...
              <div class="hero17-fragment2">
                <span class="hero17-text6">Contact Me</span>
              </div>
            </slot>
          </span>
        </button>
